...
%%临时测试汉字不同locale字体
\newCJKfontfamily\serifcjkkr{Noto Serif CJK KR}
\newCJKfontfamily\serifcjksc{Noto Serif CJK SC}
\newCJKfontfamily\serifcjktc{Noto Serif CJK TC}
\newCJKfontfamily\serifcjkhk{Noto Serif CJK HK}
\newCJKfontfamily\serifcjkjp{Noto Serif CJK JP}

\newCJKfontfamily\sanscjkkr[Path=../fonts/]{NotoSansCJKkr-Regular.otf}
\newCJKfontfamily\sanscjksc[Path=../fonts/]{NotoSansCJKsc-Regular.otf}
\newCJKfontfamily\sanscjktc[Path=../fonts/]{NotoSansCJKtc-Regular.otf}
\newCJKfontfamily\sanscjkhk[Path=../fonts/]{NotoSansCJKhk-Regular.otf}
\newCJKfontfamily\sanscjkjp[Path=../fonts/]{NotoSansCJKjp-Regular.otf}
\fi
...
\subsubsection*{汉字locale}
KR {\serifcjkkr 歡迎 欢迎} {\sanscjkkr 歡迎 欢迎} 
  \begin{korean}
    \begin{jamotext}
      hoan/ qyef
    \end{jamotext}
  \end{korean}\newline
SC {\serifcjksc 歡迎 欢迎} {\sanscjksc 歡迎 欢迎}\newline
TC {\serifcjktc 歡迎 欢迎} {\sanscjktc 歡迎 欢迎}\newline
HK {\serifcjkhk 歡迎 欢迎} {\sanscjkhk 歡迎 欢迎}\newline
JP {\serifcjkjp 歡迎 欢迎} {\sanscjkjp 歡迎 欢迎}\newline
